...
{
#if NET6_0_WINDOWS
    public partial class DragPositionBehavior : UIElement, IBehavior
#else
...
#endif
    {
        ...
        public static readonly DependencyProperty ZoomFactorProperty = DependencyProperty.Register(nameof(ZoomFactor), typeof(double), typeof(DragPositionBehavior), new PropertyMetadata(1));
