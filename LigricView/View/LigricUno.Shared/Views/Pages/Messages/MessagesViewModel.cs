...
namespace LigricUno.Views.Pages.Messages
{
    public class MessagesViewModel
    {
        ...
        {
            new MessageItem("ms-appx:///Assets/Images/limeniye_icon.JPG", "Alexey True", "😁😁😁", DateTime.Now),
            ...
            new MessageItem("ms-appx:///Assets/Images/Даня Караконстантин.jpg", "Даня Караконстантин", "ыыыы", DateTime.Now)
        };
    }
